...
export const DP_ME: Image = {
  src: "/me.jpg",
  alt: "Photo of me in Japan with some bamboo in the background",
};
...
export const TECHNICAL_SPECIALISATIONS: TextCard[] = [
  {
    ...
    description:
      "A strong understanding of web developments, from front-end structure and styling (HTML, CSS, JavaScript) to back-end interactions through APIs and databases.",
  },
  {
    title: "React Web Development",
    description:
      "Experienced in building web applications using React and Tailwind CSS, with various back end technologies such as Laravel, .NET, and WordPress REST API.",
  },
  {
    title: "Agile Projects",
    description:
      "I have experience working within agile projects, collaborating with POs, clients, and small teams to deliver product features through each structured sprint.",
  },
  {
    title: "WordPress Development",
    description:
      "My foundation is in custom WordPress development in PHP, including custom child theme and plugin creation, and complex Elementor builds.",
  },
  {
    title: "Security, Accessability, & QA",
    description:
      "Security, accessability, and creating an all-round well made user-friendly application are at the top of my mind throughout any project.",
  },
  {
    title: "Web & Digital Design Roots",
    description:
      "I had my start in the industry with graphic design, crafting webpage designs, pdfs and icons, and prototypes in Figma. I later chose to move more towards development.",
  },
];
...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  {
    ...
    excerpt:
      "I have been crafting bespoke landing pages for Cliq MC as a freelancer since late 2023 and I love working with Esther, Tim & the team! This work is mostly more design-focused, using Elementor page builder (and sometimes a little CSS) to create unique page designs.",
    featuredImage: {
  ...
  },
  {
    ...
    excerpt:
      "I was one of the main developers for a website project using React/Typescript & Laravel for Calibo. This was a custom website build based on a Figma design using Tailwind. This project was really enjoyable for me, and I loved experiencing working on both Front End & Back End components.",
    featuredImage: {
      src: "/portfolio/calibo.jpg",
      alt: "Calibo Website Build",
    },
  ...
  },
  {
    ...
    excerpt:
      "I worked as a Front End developer on a large React & Laravel project for Lighting Illusions. This was a custom ecommerce website rebuild based on a Figma design using Tailwind. This project was managed in an Agile style with each developer being responsible for a certain number of stories to deliver in each sprint.",
    featuredImage: {
      src: "/portfolio/lighting-illusions.jpg",
      alt: "Lighting Illusions Website Rebuild",
    },
  ...
  },
  {
    ...
    featuredImage: {
      src: "/portfolio/ceiling-fans-direct.jpg",
      alt: "Ceiling Fans Direct Website Rebuild",
    },
  ...
  },
  {
    ...
    excerpt:
      "I was tasked to work on the new Slade Industries website rebuild and redesign project. Apart from initial mockups of the home page completed by a former in-house designer, I was the lead designer & developer for this project. I also designed a separate landing page for their SiEx technology. I designed & built the rest of the website based off the existing initial home page design to give it a consistent and polished feel, then deployed the site onto the live hosting environment once completed.",
    featuredImage: {
      src: "/portfolio/slade-industries.jpg",
      alt: "Slade Industries Website Rebuild",
    },
