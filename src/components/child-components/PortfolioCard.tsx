        ...
        >
          <a href={project.siteUrl ?? "#"} target="_blank">
            ...
            <img
              ...
              alt={project.featuredImage.alt ?? "preview of project"}
            />
          </a>
        </div>
      ) : (
        ...
        <div className="top-section">
          ...
          {project.workingFor ? (
            <span>
              Working For
              <InlineLink
                href={project.workingForLink ?? "#"}
                text={project.workingFor}
              />
              | {project.dateLaunched ?? ""}
            </span>
          ) : (
        ...
        <div className="bubbles">
          {project.techStack.length > 0 &&
            project.techStack.map((tech) => {
              return (
                <span key={slugify(tech)} className="bubble">
                  {tech}
                </span>
              );
            })}
